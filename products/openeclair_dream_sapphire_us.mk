...
PRODUCT_COPY_FILES += vendor/openeclair/prebuilt/dream-sapphire/lib/libopencore_author.so:system/lib/libopencore_author.so
PRODUCT_COPY_FILES += vendor/openeclair/prebuilt/dream-sapphire/lib/libopencore_common.so:system/lib/libopencore_common.so
PRODUCT_COPY_FILES += vendor/openeclair/prebuilt/dream-sapphire/lib/libopencore_downloadreg.so:system/lib/libopencore_downloadreg.so
PRODUCT_COPY_FILES += vendor/openeclair/prebuilt/dream-sapphire/lib/libopencore_download.so:system/lib/libopencore_download.so
PRODUCT_COPY_FILES += vendor/openeclair/prebuilt/dream-sapphire/lib/libopencorehw.so:system/lib/libopencorehw.so
PRODUCT_COPY_FILES += vendor/openeclair/prebuilt/dream-sapphire/lib/libopencore_mp4localreg.so:system/lib/libopencore_mp4localreg.so
PRODUCT_COPY_FILES += vendor/openeclair/prebuilt/dream-sapphire/lib/libopencore_mp4local.so:system/lib/libopencore_mp4local.so
PRODUCT_COPY_FILES += vendor/openeclair/prebuilt/dream-sapphire/lib/libopencore_net_support.so:system/lib/libopencore_net_support.so
PRODUCT_COPY_FILES += vendor/openeclair/prebuilt/dream-sapphire/lib/libopencore_player.so:system/lib/libopencore_player.so
PRODUCT_COPY_FILES += vendor/openeclair/prebuilt/dream-sapphire/lib/libopencore_rtspreg.so:system/lib/libopencore_rtspreg.so
PRODUCT_COPY_FILES += vendor/openeclair/prebuilt/dream-sapphire/lib/libopencore_rtsp.so:system/lib/libopencore_rtsp.so
